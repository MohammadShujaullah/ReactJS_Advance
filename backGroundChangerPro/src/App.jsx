...
function App() {
  ...
  return (
    <>
      <div className="w-screen h-screen duration-200"  // ye duration delay btata ha ,kitne time main color change hoga if ,button click kroge tb
        style={{ backgroundColor: color }}>
        <div className="fixed flex flex-wrap
      justify-center bottom-12 inset-x-0 px-2">
          <div className="flex flex-wrap justify-center
        gap-3 shadow -lg bg-white px-3 py-2 round-3xl">
